...
# # Example of parsing the text and creating a family tree structure
# # This part is highly dependent on the format of the extracted text
# # For simplicity, let's assume the text is in a specific format
# # Example format: "Parent -> Child1, Child2"
...
for line in lines:
    if '->' in line:
        ...
        parent = parent.strip()
        children = [child.strip() for child in children.split(',')]
        print(f"Parent: {parent}, Children: {children}")  # Debug print
        for child in children:
            family_tree.add_edge(parent, child)
